            ...
            <Container>
                <Row className='textbackground'>
                    <Col md={9} >
                        ...
                        My name is Mahesh, I'm a Frontend enthusiastic Web Developer from Nellore, Andhra Pradesh.Currently looking for an opportunity to show my potential in Web Development.I have 2.2 years of experience working as a Frontend Developer.
                    ...
                    <Col md={3}>
                    <img src="https://i.ibb.co/tXDKPk1/picture-new-one.png" alt="mahesh pic" className="image" />
